...
export const Cont = () =>{
  ...
  const defaulNumber = '5541998057793'
      ...
      <div className={style.wrapContainer}>
        ...
        <div className={style.wrapDivs}>
          ...
          <div className={style.wrapMessage}>
            <h2>Message Us</h2>
            <div>
                <input placeholder='Nome' type="text" id="name" name='name' value={formData.name} onChange={handleChange} required />
            </div>
            <div>
                <input placeholder='Email' type="text" id="email" name='email' value={formData.email} onChange={handleChange} required />
            </div>
            <div>
                <textarea placeholder='Mensagem' id="message" name='message' value={formData.message} onChange={handleChange} required></textarea>
            </div>
            <div className={style.btn}>
              <button onClick={handleMessage}>Mandar Mensagem</button>
            </div>
          </div>
        </div>
      </div>
